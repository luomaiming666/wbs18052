	...
	for(var i=0; i<4; i++)
		for(j=0; j<4; j++){
			...
			if(board[i][j]==0){
				...
				if (randNumber==2){
				theNumberCell.text("4096");
				}
				else if(randNumber==4){
					theNumberCell.text("2048");
				}
				else if(randNumber==8){
					theNumberCell.text("1024");
				}
				else if(randNumber==16){
					theNumberCell.text("512");
				}
				else if(randNumber==32){
					theNumberCell.text("256");
				}
				else if(randNumber==64){
					theNumberCell.text("128");
				}
				else if(randNumber==128){
					theNumberCell.text("64");
				}
				else if(randNumber==256){
					theNumberCell.text("32");
				}
				else if(randNumber==512){
					theNumberCell.text("16");
				}
				else if(randNumber==1024){
					theNumberCell.text("8");
				}
				else if(randNumber==2048){
					theNumberCell.text("4");
				}
				else if(randNumber==4096){
					theNumberCell.text("2");
				}
